...
class CustomerSvnController extends Controller
{
    ...
    {
        CustomerSvn::updateOrCreate(['id' => $request->id],['company_id' => $request->company,'name'=>$request->customer_name,'name_short'=>$request->customer_short,'phone'=>$request->phone,'address'=>$request->address,'notes'=>$request->note]);        
